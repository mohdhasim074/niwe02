...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Staff_Section', '0006_alter_directorgeneralofficestaff_phone_number'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Staff_Section.directorgeneralofficestaff')),
            ],
        ),
    ]
